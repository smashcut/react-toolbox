...
var factory = function factory(FontIcon) {
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            counterTextFn = _props.counterTextFn,
            ...
            others = _objectWithoutProperties(_props, ['children', 'counterTextFn', 'defaultValue', 'disabled', 'error', 'floating', 'hint', 'icon', 'name', 'label', 'maxLength', 'multiline', 'required', 'theme', 'type', 'value', 'onKeyPress', 'rows']);
        ...
        var counterText = counterTextFn ? counterTextFn(length, maxLength) : length + '/' + maxLength;
  ...
  Input.propTypes = {
    ...
    counterTextFn: _propTypes2.default.func,
